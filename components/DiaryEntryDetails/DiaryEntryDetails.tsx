    ...
    <section className={css.diaryEntryDetails}>
      <div className={css.diaryEntryDetailsWrapper}>
        ...
        <p className={css.diaryEntryDetailsContent}>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Temporibus, earum omnis harum
          doloremque voluptates ex, ducimus deserunt doloribus maxime ullam suscipit optio quo
          deleniti exercitationem quibusdam sapiente accusamus nihil saepe.
        </p>
        <div>
